...
import tournamentRegisterStyles from "~/styles/tournament-register.css";
import {
  badRequestIfFalsy,
...
export const links: LinksFunction = () => {
  return [
    { rel: "stylesheet", href: tournamentRegisterStyles },
    ...
    <div className="stack md">
      ...
      {data.ownTeam && (
        <>
          <MapPoolSection />
          <RosterSection />
          <div className="tournament-register__action-side-note">
...
function TeamNameSection() {
  ...
  return (
    <section className="tournament-register__action-section stack md">
      <div>
        <span className="tournament-register__action-section-title">
          {t("tournament:pre.steps.register")}
        </span>
      </div>
      <Details className="bg-darker-transparent rounded">
        <Summary className="bg-transparent-important">
          <div className="tournament-register__summary-content">
...
function MapPoolSection() {
  ...
  return (
    <section>
      <Form
        method="post"
        className="tournament-register__action-section stack md"
      >
...
function MapPoolCounts({ mapPool }: { mapPool: MapPool }) {
  ...
  return (
    <div className="tournament-register__map-pool-counts">
      ...
      {rankedModesShort.map((mode) => {
        ...
        return (
          <div
            key={mode}
            className={clsx("tournament-register__map-pool-count", {
...
// TODO: add trusted users without sending link
// xxx: show invite code
...
//         }}
//       />
//       <div className="tournament-register__teams-container">
//         <TeamsSelect
//           number={1}
//           team={teamOne}
//           otherTeam={teamTwo}
...
//   return (
//     <div className="tournament-register__round-container tournament-register__select-container">
...
//   return (
//     <div className="tournament-register__select-container">
//       <label htmlFor="round">
//         {t("tournament:team.label")} {number}
//       </label>
//       <select
//         id="round"
//         className="tournament-register__team-select"
//         value={team.id}
//         onChange={(e) => {
...
//   return (
//     <div className="tournament-register__bo-radios-container">
...
//   return (
//     <div className="tournament-register__map-list">
...
//             />
//             <div key={stageId} className="tournament-register__stage-listed">
...
//   return (
//     <div className={clsx("tournament-register__pick-info", otherClassName())}>
//       {text()}
//     </div>
//   );
// }
