    ...
    <>
      <div style={{ padding: "5px" }}>
        ...
        <div style={{ paddingTop: "15px" }}>
          ...
          - Browse past tournaments. You can easily find out how certain comps
          have worked in the past by using the search filters.
        </div>
        <div style={{ paddingTop: "15px" }}>
          <b>
            <Link to="/trends">X Rank Trends</Link>
          </b>{" "}
          - Compare weapons on a chart based on how many times they finished in
          the Top 500 of X Rank. You can also combine weapon data freely.
        </div>
        <div style={{ paddingTop: "15px" }}>
          <b>
